...
$form_id = GFFormsModel::get_form_id( '0003 FormConnector - Source' );
$steps = gravity_flow()->get_steps( $form_id );
foreach ( $steps as $step ) {
	if ( $step->get_name() == 'Form Submission Source' ) {

		$submit_page = get_page_by_title( '0003 FormConnector - Destination' );
